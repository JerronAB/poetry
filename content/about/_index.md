...
One of my main requirements for this website is that it feels snappy. For that reason, I don't use any frameworks or fetch any external content. I use a static site generator, Hugo, and a custom theme. If you're familiar with Hugo, feel free to make suggestions about my theme setup on the [GitHub](https://github.com/JerronAB/poetry) repo. 